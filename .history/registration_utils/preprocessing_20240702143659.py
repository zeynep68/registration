...
class DataPreparation:
	def __init__(self, fixed_pyramid_lvl, moving_pyramid_lvl, fixed_um_per_px=32.18880081176758, moving_um_per_px=1.33):	
		self.fixed_PYRAMID_LVL = fixed_pyramid_lvl
		self.TRANS_PYRAMID_LVL = moving_pyramid_lvl

		self.int_fixed_pyramid_lvl = int(fixed_pyramid_lvl)
		self.int_moving_pyramid_lvl = int(moving_pyramid_lvl)
	
		self.fixed_um_per_px = fixed_um_per_px
		self.moving_um_per_px = moving_um_per_px
  
	def compute_scaling(self):  # physical res
		moving = self.moving_um_per_px * 2**self.moving_pyramid_lvl  
		fixed = self.fixed_um_per_px * 2**self.fixed_pyramid_lvl
