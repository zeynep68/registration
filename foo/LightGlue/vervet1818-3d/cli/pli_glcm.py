...
@click.command()
@click.option("--model_name", default='pli_glcm', type=str)
...
def create_glcm(model_name, n_loaders, out_folder):
    ...
    from vervet1818_3d.utils.io import pli2glcm
    ...
    for k, r in tqdm(files_df.iterrows(), total=len(files_df)):
        ...
        out_file = os.path.basename(r.file_ret).replace('Retardation.nii', 'GLCM')
